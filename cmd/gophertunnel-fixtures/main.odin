...
main :: proc() {
    ...
    emit_packet(
        "packet_interact",
        packet.Interact{
            action_type = packet.Interact_Action_Mouse_Over_Entity,
    ...
    emit_packet(
        ...
        packet.Move_Actor_Absolute{
            ...
            flags = packet.Move_Flag_On_Ground,
            position = {1.25, 2.5, 3.75},
            rotation = {45, 90, 180},
        },
    )
    emit_packet(
        ...
        packet.Move_Actor_Delta{
            ...
            flags = packet.Move_Actor_Delta_Flag_Has_X |
                    packet.Move_Actor_Delta_Flag_Has_Z |
                    packet.Move_Actor_Delta_Flag_Has_Rot_Y,
    ...
    emit_packet(
        ...
        packet.Photo_Transfer{
            ...
            book_id = "book",
            photo_type = packet.Photo_Type_Photo_Item,
            source_type = packet.Photo_Type_Portfolio,
    ...
    emit_packet(
        ...
        packet.Set_Display_Objective{
            display_slot = packet.Scoreboard_Slot_Sidebar,
            objective_name = "kills",
            display_name = "Kills",
            criteria_name = "dummy",
            sort_order = packet.Scoreboard_Sort_Order_Descending,
        },
    )
    emit_packet(
    ...
    emit_packet(
        ...
        packet.Unlocked_Recipes{
            unlock_type = packet.Unlocked_Recipes_Type_Newly_Unlocked,
